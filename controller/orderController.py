...
class OrderController:
    ...
    def new_order(cls, post_data):
        ...
        @classmethod
        def UpDateOrder(cls, post_data, order_id):

            if "order" in post_data and "email" in post_data["order"] \
                    and "country" in post_data["order"]["shipping_information"] and "address" in post_data["order"][
                "shipping_information"] \
                    and "postal_code" in post_data["order"]["shipping_information"] and "city" in post_data["order"][
                "shipping_information"] \
                ...
                ShippingInformation.PUT(country=country, address=address, postal_code=postal_code, \
